...
class EnergyDetailsPopup(Popup):
    ...
    def updateYield(self, whatarg):
        ...
        print('1 updateYield(): self.screen_mode = ' + self.screen_mode + ' self.yield_mode = ' + self.yield_mode)
        ...
        print('2 updateYield(): self.screen_mode = ' + self.screen_mode + ' self.yield_mode = ' + self.yield_mode)
