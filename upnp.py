...
class upnp():
    ...
    def findRequest(self, data, searchType, searchName):        
        ...
        if messageType != False:            
            ...
            #print('actualType: ' + actualType + ' actualName: ' + actualName)
